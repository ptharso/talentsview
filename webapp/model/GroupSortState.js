sap.ui.define([
	...
	return BaseObject.extend("talentsview.model.GroupSortState", {
		 ...
		 * @alias talentsview.model.GroupSortState
		 */
		...
		/**
		 * Sorts by firstName, or by bonusTarget
		 *
		...
		/**
		 * Groups by bonusTarget, or resets the grouping for the key "None"
		 *
		 * @param {string} sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function (sKey) {
			...
			if (sKey === "bonusTarget") {
				...
				this._oViewModel.setProperty("/sortBy", "bonusTarget");

				aSorters.push(
					new Sorter("bonusTarget", false,
